...
# PyInstaller için Flask dizin yollarını ayarlama
...
def run_server():
    initialize_vjoy(debug=False) # PyInstaller versiyonunda debug kapatılmalı
    # use_reloader=False zorunludur, aksi takdirde PyInstaller içinde Flask 2 defa başlatılmaya çalışıp hata verir.
